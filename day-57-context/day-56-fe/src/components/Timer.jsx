...
export default function Timer({
                                  title, project, id, elapsed, runningSince,
                              }) {
    const elapsedString = renderElapsedString(elapsed, runningSince);
    const {handleTrashClick, handleStartClick, handleStopClick} = useContext(TimerContext);
    ...
    return (<Container maxWidth="sm">
        <Card sx={{maxWidth: 345, margin: "0 auto", marginBottom: 5}}>
            <CardContent>
                ...
                <Box
                    sx={{
                        display: "flex", justifyContent: "flex-end", alignItems: "center", marginBottom: "20px",
                    }}
                >
